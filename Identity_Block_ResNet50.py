...
def identity_2d_block(input_img, filters, kernel_size = 3):
    """
    ...
    x = Conv2D(kernel_size = 1, filters = filter1, strides = 1, kernel_initializer = glorot_uniform(seed = 0), padding = "valid")(input_img) # seed of glorot uniform initializer is set to 0 for random initialization
